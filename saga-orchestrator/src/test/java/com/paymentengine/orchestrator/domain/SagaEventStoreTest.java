...
class SagaEventStoreTest {

    @Mock
    private SagaEventRepository repository;

    private SagaEventStore store() {
        return new SagaEventStore(repository);
    }
    ...
    void appendInitiatedWritesSequenceZero() {
        ...
        SagaEvent saved = captor.getValue();
    ...
    void loadAllGroupsEventsPerPaymentAndSortsByUpdatedAtDescending() {
        ...
        List<PaymentSagaAggregate> all = store().loadAll();
