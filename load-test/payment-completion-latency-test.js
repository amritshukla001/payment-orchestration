...
// design). This script measures how long the whole payment actually takes to
...
const paymentCompletionSeconds = new Trend('payment_completion_seconds', true);
const paymentCompletionTimeouts = new Counter('payment_completion_timeouts');
...
export default function () {
  ...
  if (elapsedMs !== null) {
    ...
    paymentCompletionSeconds.add(elapsedMs, { finalState });
  } else {
    paymentCompletionTimeouts.add(1);
  }
