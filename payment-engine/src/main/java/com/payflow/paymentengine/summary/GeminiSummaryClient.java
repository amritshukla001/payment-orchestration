...
/**
 * The one place payment-engine talks to an external LLM API -- Google's
 ...
 * already-final transition history; it never participates in a payment decision,
...
public class GeminiSummaryClient {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            Given a payment's timeline, write a 2-4 sentence plain-English summary of
