 ...
 * once per payment. The payment's own facts live in payment_saga_events; this
 * is derived prose about them, safe to delete and regenerate at any time.
 */
@Entity
@Table(name = "payment_saga_summaries")
public class PaymentEngineSummary {
    ...
    protected PaymentEngineSummary() {
        // JPA
    }

    public PaymentEngineSummary(UUID paymentId, String summary, Source source, Instant generatedAt) {
