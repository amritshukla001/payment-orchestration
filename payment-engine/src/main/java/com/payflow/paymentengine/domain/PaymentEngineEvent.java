...
/**
 * One immutable fact per payment transition -- never updated or deleted, the
 * same append-only discipline as ledger-service's LedgerEntry. This is the
 * payment's actual system of record; PaymentEngineAggregate is a disposable
...
public class PaymentEngineEvent {
    ...
    protected PaymentEngineEvent() {
        // JPA
    }

    public PaymentEngineEvent(UUID id, UUID paymentId, int sequenceNumber, String eventType, String toState,
